...
namespace QuickType
{
    ...
    public partial class countryV3
    {
        [JsonProperty("name")]
    ...
    public partial class countryV3
    {
        public static List<countryV3> FromJson(string json) => JsonConvert.DeserializeObject<List<countryV3>>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<countryV3> self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
